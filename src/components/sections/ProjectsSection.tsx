            ...
            >
              <Card className="border-none shadow-lg hover:shadow-2xl transition-all duration-500 h-full group overflow-hidden">
                ...
                <CardHeader className="flex flex-row items-start justify-between gap-4 space-y-0">
                  ...
                  {project.isPrivate && (
                    <Badge variant="secondary" className="bg-amber-500/10 text-amber-500 border border-amber-500/20 flex items-center gap-1 shrink-0">
                ...
                <CardContent className="space-y-4">
                  ...
                  {project.liveLink && project.liveLink !== "#" && (
                    ...
                    >
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-sm font-medium text-primary hover:text-primary/80 transition-colors duration-200 group/link"
                      >
                        <Globe className="w-4 h-4 text-muted-foreground group-hover/link:text-primary transition-colors duration-200" />
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    {project.isPrivate ? (
                      <Button size="sm" variant="outline" className="opacity-60 cursor-not-allowed text-muted-foreground" disabled>
